...
namespace NerdStore.Catalogo.Domain.Tests
{
    public class ProdutoTests
    {
        ...
        public void Produto_Validar_ValidacoesDevemRetornarExceptions()
        {
            ...
            Assert.Equal("O campo Valor do produto não pode ser menor que o minimo!", ex.Message);
            ...
            Assert.Equal("O campo Altura deve ser no minimo maior ou igual a 1!", ex.Message);
        }
    }
}